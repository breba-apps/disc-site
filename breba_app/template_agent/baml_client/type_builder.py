...
class TypeBuilder(type_builder.TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["LLMMessage","Question","WebsiteSpecification",]
        ), enums=set(
          []
    ...
    @property
    def Question(self) -> "QuestionViewer":
        return QuestionViewer(self)

    @property
    def WebsiteSpecification(self) -> "WebsiteSpecificationViewer":
        return WebsiteSpecificationViewer(self)
...
class LLMMessageAst:
    ...
    @property
    def props(self) -> "LLMMessageProperties":
        return self._props


class LLMMessageViewer(LLMMessageAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class WebsiteSpecificationAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("WebsiteSpecification")
        self._properties: typing.Set[str] = set([  "spec",  ])
        self._props = WebsiteSpecificationProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "WebsiteSpecificationProperties":
        return self._props


class WebsiteSpecificationViewer(WebsiteSpecificationAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class WebsiteSpecificationProperties:
    def __init__(self, bldr: baml_py.ClassBuilder, properties: typing.Set[str]):
        self.__bldr = bldr
        self.__properties = properties # type: ignore (we know how to use this private attribute) # noqa: F821
    ...
    @property
    def spec(self) -> type_builder.ClassPropertyViewer:
        return type_builder.ClassPropertyViewer(self.__bldr.property("spec"))
