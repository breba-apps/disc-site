...
class FileListAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("FileList")
        self._properties: typing.Set[str] = set([  "reasoning",  "files",  ])
        self._props = FileListProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "FileListProperties":
        return self._props


class FileListViewer(FileListAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
