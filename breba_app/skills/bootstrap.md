...
To make sure the collapse menu animation works smoothly, need to make sure there there is no vertical resizing of the menu when the items are opened or closed.
